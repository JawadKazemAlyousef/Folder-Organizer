...
//		System.out.println(mainObj.getRunFileSettings());
	...
	public void organizeSetting(OrganizeFolderMainUI mainObj) {
		...
		if(mainObj.getInitialSavedSetting() != 1) {
			...
			// Fixed info
			String[] folderNames = {"Images", "Videos", "Sounds & Musics", "Documents", "Compressed", "Programs", "Programming Languages"};
			String[][] extenstionsForEachFolder = {{}};
			...
			for (int i=0; i< folderNames.length; ++i) {
				...
				if(mainObj.getLanguageMode() == 1) {
					switch (i) {
						...
						case 1: {
							...
							folderNames[1] = "الفيديوهات";
						}
						case 2: {
							
							folderNames[2] = "الأصوات والموسيقى";
						}
						case 3: {
							
							folderNames[3] = "المستندات";
						}
						case 4: {
							
							folderNames[4] = "المضغوطات";
						}
						case 5: {
							
							folderNames[5] = "البرامج";
						}
						case 6: {
							
							folderNames[6] = "اللغات البرمجية";
						}
				...
				System.out.println(new File(mainObj.getPathFolder().getText()+"/"+folderNames[i]).mkdirs());

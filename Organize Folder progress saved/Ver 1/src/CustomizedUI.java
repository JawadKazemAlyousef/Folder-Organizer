...
public class CustomizedUI {
	...
	public void runCustomizedUI(OrganizeFolderMainUI mainObj) {
    	...
    	mainObj.runSetting(false, true, false, getCustomizedScene());
        ...
        Button custom = mainObj.buttonProperty("Custom");
        ...
        buttonCenter.getChildren().addAll(custom, organize);
        buttonCenter.setSpacing(15);
        buttonCenter.setAlignment(Pos.CENTER);
        
        VBox vBoxCenter = new VBox();
        vBoxCenter.getChildren().addAll(chooseFolder, mainObj.getPathFolder(), buttonCenter);
...
//			System.out.println("check");
	...
	public void helpSetting(OrganizeFolderMainUI mainObj) {
	    ...
	    Text content = new Text("Customized mode: Organize the files based on your customized choice\n\n"+
	    						"Instruction: \n\n"+
	    						"1. In progress\n\n"+
	    						"2. In progress");
	    ...
	    helpDialog.setStyle("-fx-font-size:20; -fx-text-align:center;");

	...
	public void organizeSetting(OrganizeFolderMainUI mainObj) {
		...
		for (int i = 0;  i < folderContents.length; ++i) {
			...
			if(organizedChecker.isFile()) {
				...
				System.out.println("Extention: "+folderContents[i].substring(folderContents[i].indexOf(".")+1));
				folderExtentionFormat.add(folderContents[i].substring(folderContents[i].indexOf(".")+1));
				count++;
				System.out.println();
			}
		}

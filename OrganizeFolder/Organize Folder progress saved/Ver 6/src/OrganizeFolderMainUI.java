...
public class OrganizeFolderMainUI extends FolderOrganizerDriver{
	...
	//for consistent changes of theme between various pages in one run 
			    			...
			    			Scanner scan= new Scanner(runSetting);
			 	    	   	...
			 	    	   	if(fileValues[2] == 1) {
			 	    	   		...
			 	    	   		Text contentArabic = new Text("هل أنت متأكد: تخزينتك المختارة غير صالحة!\n\n "+
			 	    	   									  ...
			 	    	   									  "أو تريد أنت تفتح التخزينة الافتراضية؟");
			 	    	   		...
			 	    	   		window.setOnCloseRequest(e -> {
			 	    	   			try {
			 	    	   				confirmAlert.close();
				 	    	   			String runPathC = "src/Resources/Mode settings/Saved settings.txt";
...
// 	 	    System.out.println(openSetting.getAbsolutePath());
   ...
   public void helpSetting() {
	    ...
	    if(getLanguageMode() == 0) {
		    ...
		    content = new Text("The purpose of the program is to organize the files of the chosen folder based on three type modes:\n\n"+
		    						"Standard mode: Organize the files of the chosen folder based on their extension format\n\n"+
		    						"Recommended mode: Organize the files of the chosen folder based on my recommended choice\n\n"+
					 				"Customized mode: Organize the files of the chosen folder based on your customized choice");
		    content.setStyle("-fx-font-size:20;");
		    ...
		    content = new Text("الغرض من 'منظم الملفات' تنظيم ملفات المجلد المختار حسب ثلاثة أوضاع: \n\n"+
		    						"الوضع العادي: ينظم ملفات المجلد المختار حسب صيغهم\n\n"+
		    						"الوضع الموصى: ينظم ملفات المجلد المختار حسب ما استحسنه\n\n"+
					 				"الوضع المخصص: ينظم ملفات المجلد المختار حسب ما تخصصه");
		    content.setStyle("-fx-font-size:20; direction: ltr;");
   ...
   public void aboutSetting() {
	   	...
	   	if(getLanguageMode() == 0) {
		    ...
		    aboutAlert.setHeaderText("About <Folder Organizer>");
	    	...
	    	Window window = aboutAlert.getDialogPane().getScene().getWindow();
		    ...
		    content = new Text("برمج البرنامج بواسطة جواد اليوسف\n\n"+
		    					"البرنامج مفتوح المصدر، يمكنك استخدامه وتعديل الكود إن أردت تحسينه\n\n"+
		    					"لا تنس أن تنسبني في العمل\n\n"+
		    					"الإصدار: "+getVersion()+

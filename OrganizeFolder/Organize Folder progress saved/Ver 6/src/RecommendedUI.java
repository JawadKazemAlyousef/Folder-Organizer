...
//		System.out.println(mainObj.getRunFileSettings());
	...
	public void helpSetting(OrganizeFolderMainUI mainObj) {
		...
		if(mainObj.getLanguageMode() == 0) {
			    ...
			    content = new Text("Recommended mode: Organize the files of the chosen folder based on my recommended choice\\n\\n"+
			    					"Instruction: \n\n"+
			    					"1. Choose the path location (the folder) that you want to organize its files\n\n"+
			    					"2. Press <Organize> button to organize the folder's files based on my recommended choice");
		    ...
		    content = new Text("الوضع الموصى: ينظم ملفات المجلد المختار حسب ما استحسنه \n\n"+
					 		   "التعليمات: \n\n"+
					 		   "1. اختر المسار (موقع المجلد) الذي تريد أن ترتب ملفاته \n\n"+
		    				   "2. انقر على زر <نظم> لتنظم ملفات المجلد المختار حسب ما استحسنه");
